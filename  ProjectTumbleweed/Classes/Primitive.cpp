...
//cocos2d::Vec2 Pm::CirclePrimitive::getLocation() const
//{
//	return cocos2d::Vec2(location.x,location.y);
//}

//void Pm::CirclePrimitive::setLocation(const cocos2d::Vec2 & LOCATION)
//{
//	location.x = LOCATION.x;
//	location.y = LOCATION.y;
//}
